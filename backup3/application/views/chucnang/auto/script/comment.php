                    ...
                    if(post['privacy']['value'] =='EVERYONE'){
                        ...
                        \
                                <div class="pull-right">\
                                    <button onclick="submit_id(\''+post['id']+'\')" type="button" class="btn btn-danger btn-xs getid" style="margin-top:10px; margin-right:1px; margin-bottom:1px; background-color: red;"><b>TĂNG COMMENT BÀI VIẾT NÀY</b>\
                                    </button>\
                                </div>\
                            </div>\
                        </div>');
...
function tinh_noi_dung(){
    var nd = $('#noidung').val();
    if(nd == ''){
        $('#sonoidung').html(0);
    }else{
        var tach = nd.split('\n');
        $('#sonoidung').html(tach.length);
    }
