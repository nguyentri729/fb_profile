...
(function($) { /*!* smoothState.js is jQuery plugin that progressively enhances * page loads to behave more like a single-page application. * * @author Miguel Ãngel PÃ©rez reachme@miguel-perez.com * @see http://smoothstate.com **/
    ! function(t) {
        "use strict";
    ...
    ! function(e) {
        ...
        e.fn.readingTime = function(i) {
            ...
            if ("it" == s.lang) var l = s.lessThanAMinuteString || "Meno di un minuto",
                ...
                u = "min";
            else if ("sk" == s.lang) var l = s.lessThanAMinuteString || "Menej neÅ¾ minÃºtu",
                u = "min";
            else if ("cz" == s.lang) var l = s.lessThanAMinuteString || "MÃ©nÄ› neÅ¾ minutu",
                u = "min";
            else if ("hu" == s.lang) var l = s.lessThanAMinuteString || "Kevesebb mint egy perc",
                u = "perc";
            else if ("ru" == s.lang) var l = s.lessThanAMinuteString || "ÐœÐµÐ½ÑŒÑˆÐµ Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹",
                u = "Ð¼Ð¸Ð½";
            else if ("ar" == s.lang) var l = s.lessThanAMinuteString || "Ø£Ù‚Ù„ Ù…Ù† Ø¯Ù‚ÙŠÙ‚Ø©",
                u = "Ø¯Ù‚ÙŠÙ‚Ø©";
            else if ("da" == s.lang) var l = s.lessThanAMinuteString || "Mindre end et minut",
                u = "min";
            else if ("is" == s.lang) var l = s.lessThanAMinuteString || "Minna en eina mÃ­nÃºtu",
                u = "min";
            else if ("no" == s.lang) var l = s.lessThanAMinuteString || "Mindre enn ett minutt",
                u = "min";
            else if ("pl" == s.lang) var l = s.lessThanAMinuteString || "Mniej niÅ¼ minutÄ™",
                u = "min";
            else if ("ru" == s.lang) var l = s.lessThanAMinuteString || "ÐœÐµÐ½ÑŒÑˆÐµ Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹",
                u = "Ð¼Ð¾Ð¹";
            else if ("sv" == s.lang) var l = s.lessThanAMinuteString || "Mindre Ã¤n en minut",
                u = "min";
